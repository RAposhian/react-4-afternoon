    ...
    return (
      <div>
        <div className='subnav'>
          <Link to='/about' className='subnav_links'><span>About</span></Link>
          <Link to='/about/history' className='subnav_links'><span>History</span></Link>
          <Link to='/about/contact' className='subnav_links'><span>Contact</span></Link>
        </div>
        <div className='box'>
          <Switch>
